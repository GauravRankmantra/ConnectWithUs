      ...
      <div className="md:w-8/12 mx-auto mt-10">
        ...
        <div className="bg-[#1A2E5C] p-5 text-white">
          <Form form={form} layout="vertical" onFinish={handleFinish}>
            ...
            <Form.Item name="birthdayCount" label="If so how many?">
              <Input />
            </Form.Item>
            ...
            <Form.Item name="weddingAnniversaryCount" label="If so how many?">
              <Input />
            </Form.Item>
            ...
            <Form.Item name="spiritualBirthdayCount" label="If so how many?">
              <Input />
            </Form.Item>
            ...
            <div className="w-full border p-2 mx-auto text-white h-[15rem] overflow-scroll">
              <p>
                ...
                Make it explicit that the event is open and welcoming to people
                of all backgrounds, regardless of race, ethnicity, religion,
                gender identity, sexual orientation, disability, or any other
                characteristic.
              </p>
              <p>
                2. **Respect for Cultural and Religious Sensitivities**:
                Encourage attendees to be mindful and respectful of cultural and
                religious practices that may differ from their own. Ensure that
                the event respects dietary restrictions, dress codes, and other
                cultural norms.
              </p>
              <p>
                3. **Inclusivity in Programming**: Strive to include diverse
                perspectives and representation in the event programming,
                including speakers, performers, and activities that reflect the
                varied backgrounds of attendees.
              </p>
              <p>
                4. **Accessibility**: Ensure that the event venue is accessible
                to people with disabilities, including wheelchair access,
                accessible restrooms, and accommodations for those with sensory
                sensitivities. Provide information on accessibility features and
                services available at the event.
              </p>
              <p>
                5. **Language Accessibility**: If the event is multilingual,
                provide translation services or materials in multiple languages
                to ensure that all attendees can fully participate and
                understand the content.
              </p>
              <p>
                6. **Safety and Security**: Establish guidelines for maintaining
                a safe and secure environment, including protocols for
                addressing emergencies, conflicts, or incidents of misconduct.
                Clearly communicate how attendees can report concerns or seek
                assistance during the event.
              </p>
              <p>
                7. **Informed Consent**: If the event involves activities or
                interactions that may be physically or emotionally challenging,
                ensure that attendees are fully informed and able to consent to
                participate. Provide options for opting out or seeking support
                if needed.
              </p>
              <p>
                8. **Environmental Sustainability**: Encourage environmentally
                friendly practices and minimize the event's ecological footprint
                by promoting recycling, reducing waste, and using sustainable
              ...
              <p>
                ...
                related to public health, safety, and alcohol consumption if
                applicable.
              </p>
              <p>
                ...
                accountable for upholding the event's values of inclusivity and
                fairness.
              </p>
            </div>
            <Form.Item
